...
impl Tool for StartTaskTool {
    ...
    async fn execute(
        ...
        stood::perf_checkpoint!(
            ...
            &format!("parent_id={}, task={}", parent_id, &input.short_description)
        );
        ...
        stood::perf_checkpoint!(
            "awsdash.start_task.request_creation.end",
        ...
        stood::perf_checkpoint!(
            "awsdash.start_task.wait_completion.start",
            &format!("worker_id={}", agent_id)
        );
        match stood::perf_timed!("awsdash.start_task.wait_for_worker_completion", {
            ...
            Ok(result) => {
                ...
                stood::perf_checkpoint!(
                    "awsdash.start_task.wait_completion.success",
                    &format!(
                        "worker_id={}, execution_time_ms={}",
            ...
            Err(error) => {
                stood::perf_checkpoint!(
                    "awsdash.start_task.wait_completion.error",
