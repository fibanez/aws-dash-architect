...
#[async_trait]
impl AsyncResourceNormalizer for ConfigRuleNormalizer {
    async fn normalize(
        &self,
        ...
        let tags = aws_client
            ...
            .fetch_tags_for_resource("AWS::Config::ConfigRule", &resource_id, account, region)

            .await

            .unwrap_or_else(|e| {

                tracing::warn!("Failed to fetch tags for AWS::Config::ConfigRule {}: {}", resource_id, e);
