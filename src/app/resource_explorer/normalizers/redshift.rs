...
/// Normalizer for Redshift Clusters
pub struct RedshiftResourceNormalizer;

#[async_trait]
impl AsyncResourceNormalizer for RedshiftResourceNormalizer {
    async fn normalize(
        &self,
        ...
        Ok(ResourceEntry {
            resource_type: "AWS::Redshift::Cluster".to_string(),
    ...
    fn extract_relationships(
        ...
        // Redshift clusters can have relationships with VPCs, security groups, subnets, etc.
        Vec::new()
    }
