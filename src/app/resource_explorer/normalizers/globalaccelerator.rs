...
#[async_trait]
impl AsyncResourceNormalizer for GlobalAcceleratorNormalizer {
    async fn normalize(
        &self,
        ...
        let tags = aws_client
            ...
            .fetch_tags_for_resource("AWS::GlobalAccelerator::Accelerator", &resource_id, account, region)

            .await

            .unwrap_or_else(|e| {

                tracing::warn!("Failed to fetch tags for AWS::GlobalAccelerator::Accelerator {}: {}", resource_id, e);
