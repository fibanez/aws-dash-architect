...
/// Normalizer for Timestream Resources
pub struct TimestreamResourceNormalizer;

#[async_trait]
impl AsyncResourceNormalizer for TimestreamResourceNormalizer {
    async fn normalize(
        &self,
        ...
        let resource_id = raw_response
            ...
            .and_then(|v| v.as_str())
            .unwrap_or("unknown-timestream-service")
            .to_string();
    ...
    fn extract_relationships(
        ...
        for resource in all_resources {
            match resource.resource_type.as_str() {
                "AWS::IoT::Thing" => {
                    // IoT devices can stream data to Timestream
                ...
                "AWS::Lambda::Function" => {
                    // Lambda functions can write to Timestream
                    relationships.push(ResourceRelationship {
                        relationship_type: RelationshipType::Uses,
                        target_resource_id: resource.resource_id.clone(),
                        target_resource_type: resource.resource_type.clone(),
