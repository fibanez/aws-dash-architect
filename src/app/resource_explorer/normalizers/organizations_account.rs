...
/// Normalizer for AWS Organizations Accounts
pub struct OrganizationsAccountNormalizer;

#[async_trait]
impl AsyncResourceNormalizer for OrganizationsAccountNormalizer {
    async fn normalize(
        &self,
        ...
        let mut entry = ResourceEntry {
            ...
            is_child_resource: true, // Accounts are children of OUs or Roots
            account_color,
            region_color,
            query_timestamp,
        };
