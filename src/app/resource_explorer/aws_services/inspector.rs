...
impl InspectorService {
    ...
    pub async fn list_findings(
        ...
        match client.get_configuration().send().await {
            Ok(_response) => {
                ...
                json.insert(
                    "Name".to_string(),
                    serde_json::Value::String("Inspector Configuration".to_string()),
                );
                json.insert(
                    "Status".to_string(),
                ...
                json.insert(
                    "Service".to_string(),
                    serde_json::Value::String("AWS Inspector".to_string()),
                );
                json.insert(
                    "Description".to_string(),
                    serde_json::Value::String(
                        "Vulnerability assessment and security monitoring".to_string(),
                    ),
                );
            ...
            Err(e) => {
                warn!(
                    "Inspector not enabled or accessible for account {} in region {}: {}",
                    account_id, region, e
                );
                ...
                json.insert(
                    "ResourceId".to_string(),
                    serde_json::Value::String(format!("inspector-{}", account_id)),
                );
                json.insert(
                    "Status".to_string(),
                ...
                json.insert(
                    "Name".to_string(),
                    serde_json::Value::String("Inspector (Disabled)".to_string()),
                );
                json.insert(
                    "Service".to_string(),
                    serde_json::Value::String("AWS Inspector".to_string()),
                ...
                json.insert(
                    "Description".to_string(),
                    serde_json::Value::String(
                        "Vulnerability assessment service (not enabled)".to_string(),
                    ),
                );
                resources.push(serde_json::Value::Object(json));
            }
    ...
    pub async fn get_inspector_configuration(
        ...
        json.insert(
            "Description".to_string(),
            serde_json::Value::String(
                "Automated security assessments for EC2 instances and container images".to_string(),
            ),
        );
        json.insert(
            "Region".to_string(),
