...
impl CodeDeployService {
    ...
    pub async fn describe_application(
        ...
        let response = client
            ...
            .with_context(|| {
                format!(
                    "Failed to describe CodeDeploy application: {}",
                    application_name
                )
            })?;
    ...
    pub async fn describe_deployment_group(
        ...
        if parts.len() != 2 {
            return Err(anyhow::anyhow!(
                "Invalid deployment group ID format: {}",
                deployment_group_id
            ));
        }
        ...
        let response = client
            ...
            .with_context(|| {
                format!(
                    "Failed to describe CodeDeploy deployment group: {}",
                    deployment_group_id
                )
            })?;
    ...
    fn application_to_json(
        &self,
        application: &codedeploy::types::ApplicationInfo,
    ) -> serde_json::Value {
        let mut json = serde_json::Map::new();

        json.insert(
            "ApplicationName".to_string(),
            serde_json::Value::String(application.application_name.clone().unwrap_or_default()),
        );
        json.insert(
        ...
        if let Some(application_id) = &application.application_id {
            json.insert(
                ...
                serde_json::Value::String(application_id.clone()),
            );
        }
        ...
        json.insert(
            "LinkedToGitHub".to_string(),
            serde_json::Value::Bool(application.linked_to_git_hub),
        );

        if let Some(git_hub_account_name) = &application.git_hub_account_name {
            json.insert(
                "GitHubAccountName".to_string(),
                serde_json::Value::String(git_hub_account_name.clone()),
            );
        }
        ...
        if let Some(compute_platform) = &application.compute_platform {
            json.insert(
                ...
                serde_json::Value::String(compute_platform.as_str().to_string()),
            );
        }
    ...
    fn deployment_group_to_json(
        &self,
        deployment_group: &codedeploy::types::DeploymentGroupInfo,
        application_name: &str,
    ) -> serde_json::Value {
        let mut json = serde_json::Map::new();
        ...
        json.insert(
            "DeploymentGroupId".to_string(),
            serde_json::Value::String(dg_id.clone()),
        );
        ...
        if let Some(deployment_group_id) = &deployment_group.deployment_group_id {
            json.insert(
                "DeploymentGroupId".to_string(),
                serde_json::Value::String(deployment_group_id.clone()),
            );
        }
        ...
        if let Some(service_role_arn) = &deployment_group.service_role_arn {
            json.insert(
                ...
                serde_json::Value::String(service_role_arn.clone()),
            );
        }
        ...
        if let Some(deployment_config_name) = &deployment_group.deployment_config_name {
            json.insert(
                ...
                serde_json::Value::String(deployment_config_name.clone()),
            );
        }
    ...
    fn deployment_group_detail_to_json(
        &self,
        deployment_group: &codedeploy::types::DeploymentGroupInfo,
        application_name: &str,
    ) -> serde_json::Value {
        ...
        if let Some(_on_premises_instance_tag_filters) =
            &deployment_group.on_premises_instance_tag_filters
        {
            json.insert(
        ...
        if let Some(auto_scaling_groups) = &deployment_group.auto_scaling_groups {
            ...
            json.insert(
                ...
                serde_json::Value::Array(asg_names),
            );
        }
        ...
        if let Some(outdated_instances_strategy) = &deployment_group.outdated_instances_strategy {
            json.insert(
                ...
                serde_json::Value::String(outdated_instances_strategy.as_str().to_string()),
            );
        }

        if let Some(_blue_green_deployment_configuration) =
            &deployment_group.blue_green_deployment_configuration
        {
            json.insert(
        ...
        if let Some(_last_successful_deployment) = &deployment_group.last_successful_deployment {
            json.insert(
                "LastSuccessfulDeployment".to_string(),
                serde_json::Value::String("TODO: Manual conversion needed".to_string()),
            );
        }
        ...
        if let Some(_last_attempted_deployment) = &deployment_group.last_attempted_deployment {
            json.insert(
                "LastAttemptedDeployment".to_string(),
                serde_json::Value::String("TODO: Manual conversion needed".to_string()),
            );
        }
