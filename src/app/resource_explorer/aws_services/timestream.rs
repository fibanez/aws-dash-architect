...
impl TimestreamService {
    ...
    pub async fn list_databases(
        ...
        match client.describe_endpoints().send().await {
            Ok(_response) => {
                ...
                json.insert(
                    "Name".to_string(),
                    serde_json::Value::String("Timestream Service".to_string()),
                );
                json.insert(
                    "Status".to_string(),
                ...
                json.insert(
                    "Service".to_string(),
                    serde_json::Value::String("Amazon Timestream".to_string()),
                );
                json.insert(
                    "Description".to_string(),
                    serde_json::Value::String("Time series database service".to_string()),
                );
                json.insert(
                    "Region".to_string(),
            ...
            Err(e) => {
                warn!(
                    "Timestream not accessible for account {} in region {}: {}",
                    account_id, region, e
                );
                ...
                json.insert(
                    "ResourceId".to_string(),
                    serde_json::Value::String(format!("timestream-{}", account_id)),
                );
                json.insert(
                    "Status".to_string(),
                ...
                json.insert(
                    "Name".to_string(),
                    serde_json::Value::String("Timestream (Unavailable)".to_string()),
                );
                json.insert(
                    "Service".to_string(),
                    serde_json::Value::String("Amazon Timestream".to_string()),
                ...
                json.insert(
                    ...
                    serde_json::Value::String(
                        "Time series database service (not accessible)".to_string(),
                    ),
                );
                resources.push(serde_json::Value::Object(json));
            }
    ...
    pub async fn get_timestream_service(
        ...
        json.insert(
            "Description".to_string(),
            serde_json::Value::String(
                "Fast, scalable, and serverless time series database".to_string(),
            ),
        );
        json.insert(
            "Region".to_string(),
        ...
        json.insert(
            "Type".to_string(),
            serde_json::Value::String("Time Series Database".to_string()),
        );
